...
{
    /// <summary>
    /// Represents a comparator of two books by the price.
    /// </summary>
    public class ComparatorByPrice : IComparer<Book>
    {
        /// <summary>
        /// Compares the <paramref name="firstBook"/> and the <paramref name="secondBook"/> by the price.
        /// </summary>
