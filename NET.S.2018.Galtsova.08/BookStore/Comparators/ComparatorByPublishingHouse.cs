...
{
    /// <summary>
    /// Represents a comparator of two books by the publishing house.
    /// </summary>
    public class ComparatorByPublishingHouse : IComparer<Book>
    {
        /// <summary>
        /// Compares the <paramref name="firstBook"/> and the <paramref name="secondBook"/> by the publishing house.
        /// </summary>
